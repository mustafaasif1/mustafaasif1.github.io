...
const INFO = {
	...
	homepage: {
		...
		description3: `And hey, if you're a fellow coder in the area, let's connect! I'm all about expanding the network and sharing the coding vibes. See you around! 🚀`
	},
